...
public class SeamCarvingTest {
    ...
    public void computeEnergy () {
        ...
        //System.out.println(sc.computeEnergy(0,0));
    }
    ...
    public void cutBigBalloonTwoThirds () throws IOException {
        ...
        for (int i=0; i<bound; i++) {
            ...
            sc.cutSeam();
            String filename = "ballon " + i + ".jpg";
            sc.writeImage(filename);
        }
        t = System.currentTimeMillis();
    ...
    @Test
    public void cutboard23rd () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("board.jpg");
        int bound = sc.getWidth() * 5/6;
        long t0 = System.currentTimeMillis();
        long t;
        for (int i=0; i<bound; i++) {
            t = System.currentTimeMillis();
            ...
            System.out.printf("%d of %d = %d%n", i+1, bound,t);
            sc.cutSeam();
            String filename = "board " + i + ".jpg";
            sc.writeImage(filename);
        }
        t = System.currentTimeMillis();
        System.out.printf("Total t = %d%n", 1000*(t-t0));
        sc.writeImage("board-cut.jpg");     }
    ...
    static int h (int a) throws Exception {
